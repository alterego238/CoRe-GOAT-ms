...
if __name__ == '__main__':
    ...
    feature_1 = ms.Tensor(shape=(1, 540, 1024), dtype=ms.float32, init=Normal())
    q1 = ms.Tensor(shape=(1, 540, 1024), dtype=ms.float32, init=Normal())
    k1 = q1
    feature_1 = attn_encoder(q1, k1, feature_1)
    print(f'before mean feature_1.shape: {feature_1.shape}')
    feature_1 = feature_1.mean(1)
