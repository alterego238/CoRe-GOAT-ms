...
if __name__ == '__main__':
    ...
    boxes_features_1 = ms.Tensor(shape=(1, 540, 8, 1024), dtype=ms.float32, init=Normal()) #B,540*t,N,NFB
    boxes_in_1 = ms.Tensor(shape=(1, 540, 8, 4), dtype=ms.float32, init=Normal())  # B,T,N,4
